 ...
 **********************************************************************************************************************/
#define gpio_portA                        gpio_selfData.port[0]
#define gpio_portB                        gpio_selfData.port[1]
#define gpio_portC                        gpio_selfData.port[2]
#define gpio_portD                        gpio_selfData.port[3]
#define gpio_portE                        gpio_selfData.port[4]
#define gpio_portF                        gpio_selfData.port[5]

/**********************************************************************************************************************
 *Public function-like macros that DO return value and DO depend on EXTERNAL declarations
 **********************************************************************************************************************/
#define GPIO_getPortA0Input()                 ( GPIO_isPinInputRaised( gpio_portA, 0 ) )
...
#define gpio_toggleE2()                 do{ GPIO_togglePinOutput( gpio_portE, 2 ); } while(0)
