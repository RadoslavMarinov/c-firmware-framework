 ...
 *
 * @note
 *   Changing the pins used for debugging uncontRowed, may result in a lockout.
 *
 * @param[in] location
                    ...
                    bool enable)
{
  ...
  /* There are two registers contRowing the interrupt configuration:
                     ...
                     unsigned int out)
{
  ...
  /* There are two registers contRowing the pins for each port. The MODEL
