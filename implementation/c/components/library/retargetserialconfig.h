...
#if !defined(RETARGET_UART1) && !defined(RETARGET_LEUART0)
#define RETARGET_UART1    /* Use UART1 by default. */


  #define RETARGET_IRQ_NAME    UART1_RX_IRQHandler         /* USART IRQ Handler */
  #define RETARGET_CLK         cmuClock_UART1              /* HFPER Clock */
  #define RETARGET_IRQn        UART1_RX_IRQn               /* IRQ number */
  #define RETARGET_UART        UART1                       /* USART instance */
  ...
  #define RETARGET_TXPIN       9                            /* USART transmission pin */
  #define RETARGET_RXPORT      gpioPortB                    /* USART reception port */
  #define RETARGET_RXPIN       10                            /* USART reception pin */
